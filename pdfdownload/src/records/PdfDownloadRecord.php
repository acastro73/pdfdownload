...
namespace driblepdfdownload\pdfdownload\records;
 ...
 * @since     1.0.0
 */
class PdfDownloadRecord extends ActiveRecord
{
    ...
    {
        return '{{%pdfdownload_pdfdownloadrecord}}';
    }
}
