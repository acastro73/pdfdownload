...
namespace driblepdfdownload\pdfdownload\widgets;

use driblepdfdownload\pdfdownload\PdfDownload;
use driblepdfdownload\pdfdownload\assetbundles\pdfdownloadwidgetwidget\PdfDownloadWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class PdfDownloadWidget extends Widget
{
    ...
    {
        return Craft::t('pdf-download', 'PdfDownloadWidget');
    }
    ...
    {
        return Craft::getAlias("@driblepdfdownload/pdfdownload/assetbundles/pdfdownloadwidgetwidget/dist/img/PdfDownloadWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'pdf-download/_components/widgets/PdfDownloadWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(PdfDownloadWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'pdf-download/_components/widgets/PdfDownloadWidget_body',
            [
