...
namespace driblepdfdownload\pdfdownload\fields;

use driblepdfdownload\pdfdownload\PdfDownload;
use driblepdfdownload\pdfdownload\assetbundles\pdfdownloadfieldfield\PdfDownloadFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class PdfDownloadField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('pdf-download', 'PdfDownloadField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'pdf-download/_components/fields/PdfDownloadField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(PdfDownloadFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').PdfDownloadPdfDownloadField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'pdf-download/_components/fields/PdfDownloadField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
